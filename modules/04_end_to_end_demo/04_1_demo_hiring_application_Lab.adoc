...
<<<<<<< HEAD:modules/04_end_to_end_demo/04_1_demo_hiring_application_Lab.adoc
...
=======
Using the back office application (hiring_app_internal),
>>>>>>> 43eec5a06c5e9c957063e35d7b43f515d410cc33:modules/04_end_to_end_demo/04_1_demo_hiring_application.adoc
